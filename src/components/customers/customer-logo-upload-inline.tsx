...
export default function CustomerLogoUploadInline({ logoUrl, onUploaded }: { logoUrl?: string, onUploaded?: (url: string) => void }) {
  ...
  return (
    <div className="relative group">
      {preview ? (
        <img src={preview} alt="Klantlogo" className="h-[88px] w-[88px] min-w-[88px] max-h-[110px] rounded-2xl object-contain bg-[var(--bg-card-2)] border border-[var(--border-soft)] shadow-sm" style={{ aspectRatio: '1/1' }} />
      ) : (
